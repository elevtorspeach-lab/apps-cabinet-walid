      ...
      <div className="pro-card">
        ...
        <div className="pro-body">
          <div className="diligence-toolbar">
            ...
            <button id="addDiligenceSbienBtn" className="btn-success" type="button" style={{ display: 'none' }}>
              <i className="fa-solid fa-plus"></i> Ajouter S/BIENS
            </button>
            ...
            <button id="importDiligenceSbienBtn" className="btn-primary" type="button" style={{ display: 'none' }}>
              <i className="fa-solid fa-file-import"></i> Importer S/BIENS
            </button>
            <input type="file" id="diligenceSbienImportInput" accept=".xlsx,.xls" style={{ display: 'none' }} />
            ...
            <button id="deleteDiligenceSbienBtn" className="btn-danger" type="button" style={{ display: 'none' }} disabled>
              <i className="fa-solid fa-trash"></i> Supprimer cochés
            </button>
